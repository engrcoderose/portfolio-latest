...
function Skills() {
  return (
    <div className='mt-4 md:mb-28' id="skills">
      
        <motion.h1
        variants={variants}
        initial='headerInitial'
        whileInView='header'
        className='text-center text-[#2A3B47] text-4xl md:text-[3rem] font-montserrat font-bold my-28 uppercase'>Technical Skills</motion.h1>
      ...
      <div className='grid grid-rows-2 grid-cols-1 md:grid-cols-2 md:grid-rows-1 px-10 md:px-20 text-[#697477] gap-10 items-center'>
        ...
        <motion.div
          ...
          className='my-5'>
            ...
            <h1  className='text-[#5361FF] font-montserrat font-semibold text-2xl mb-4 md:text-center '>Tools</h1>
            ...
            <motion.div
              ...
              initial='initialDown'
              whileInView='Down'
              className='flex justify-between items-center w-[50px] h-[50px] my-4 md:ml-[33%]'>
